...
- Кабели для внешней прокладки (ourdoor cables) (СПД на улице)
...
КОГДА БУДЕМ РАЗБИРАТЬ НАПИСАТЬ ЧТО ЗНАЧЕНИЕ ВОЛЬТАЖА 48 ВОЛЬТ, А ТАКЖЕ ДОБАВИТЬ ТАБЛИЧКУ С ЛЕКЦИЙ
